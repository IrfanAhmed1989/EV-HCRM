...
- **Update & Delete**: Implemented end-to-end. DAL `update_session` uses the stored procedure `updateChargingSession` exclusively; no SQL fallback. `deleteChargingSession` via stored procedure with commit.
...
## Advanced Feature Sources
- PDF export: reportlab (https://www.reportlab.com/dev/docs/)
- CSV export: Python csv module (https://docs.python.org/3/library/csv.html)
- Date picker UI: tkcalendar (https://github.com/j4321/tkcalendar)
